...
> **HTML 版**: [README.html](https://pinpikokun.github.io/DST-Mod-Guide/DST-Lua-Scripting/README.html)
...
| キャラクターのセリフカスタマイズ | [Speech ファイル作成ガイド](README-speech.md) |
| MOD のコンフィグオプション詳細 | [modinfo コンフィグガイド](README-modinfo-config.md) |
...
>
> コンフィグオプションの詳細（データ型別の書き方、prefab での使い方、実践テンプレート等）は [modinfo コンフィグオプション詳細ガイド](README-modinfo-config.md) を参照してください。
...
-- セリフファイルの読み込み（詳細は Speech ファイル作成ガイドを参照: README-speech.md）
